...
Lexical::$scopes['html'] = array();
	$__scope_id = Lexical::init_closure("html", 20);
function html_form($method, $action, $code){
	$__scope_id = Lexical::init_closure("html", 21);
