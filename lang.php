...
function __pharenlang__lambdafunc2($args, $__closure_id){
	...
	$__closure_id = last($__splatargs);
		$rfs = Lexical::get_lexical_binding('__pharenlang', 91, '$rfs', isset($__closure_id)?$__closure_id:0);;
...
function comp(){
	...
	$fs = seq(array_slice(func_get_args(), 0));
		$__scope_id = Lexical::init_closure("__pharenlang", 91);
	$rfs = reverse($fs);
		Lexical::bind_lexing("__pharenlang", 91, '$rfs', $rfs);
...
function zip_with($f, $xs, $ys){
	$__scope_id = Lexical::init_closure("__pharenlang", 126);
	Lexical::bind_lexing("__pharenlang", 126, '$f', $f);
...
function __pharenlang__lambdafunc5($__closure_id){
	$n = Lexical::get_lexical_binding('__pharenlang', 129, '$n', isset($__closure_id)?$__closure_id:0);;
	return cons($n, infinity(($n + 1)));
}

function infinity($n=0){
	$__scope_id = Lexical::init_closure("__pharenlang", 129);
	Lexical::bind_lexing("__pharenlang", 129, '$n', $n);
...
function __pharenlang__lambdafunc6($__closure_id){
	$x = Lexical::get_lexical_binding('__pharenlang', 131, '$x', isset($__closure_id)?$__closure_id:0);;
	return cons($x, repeat($x));
}

function repeat($x){
	$__scope_id = Lexical::init_closure("__pharenlang", 131);
	Lexical::bind_lexing("__pharenlang", 131, '$x', $x);
...
function __pharenlang__lambdafunc7($__closure_id){
	$f = Lexical::get_lexical_binding('__pharenlang', 133, '$f', isset($__closure_id)?$__closure_id:0);;
...
function __pharenlang__lambdafunc8($__closure_id){
	$init = Lexical::get_lexical_binding('__pharenlang', 135, '$init', isset($__closure_id)?$__closure_id:0);;
	$f = Lexical::get_lexical_binding('__pharenlang', 135, '$f', isset($__closure_id)?$__closure_id:0);;
	return cons($init, iterate($f, $f($init)));
}

function iterate($f, $init){
	$__scope_id = Lexical::init_closure("__pharenlang", 135);
	Lexical::bind_lexing("__pharenlang", 135, '$f', $f);
	Lexical::bind_lexing("__pharenlang", 135, '$init', $init);
...
function __pharenlang__lambdafunc9($__closure_id){
	$xs = Lexical::get_lexical_binding('__pharenlang', 137, '$xs', isset($__closure_id)?$__closure_id:0);;
	return concat($xs, cycle($xs));
}

function cycle($xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 137);
	Lexical::bind_lexing("__pharenlang", 137, '$xs', $xs);
...
function __pharenlang__lambdafunc10($__closure_id){
		$f = Lexical::get_lexical_binding('__pharenlang', 139, '$f', isset($__closure_id)?$__closure_id:0);;
		$xs = Lexical::get_lexical_binding('__pharenlang', 139, '$xs', isset($__closure_id)?$__closure_id:0);;
	$new_xs = map($f, $xs);
...
function cycle_with($f, $xs){
	...
	Lexical::bind_lexing("__pharenlang", 139, '$xs', $xs);
...
function __pharenlang__lambdafunc13($f, $__closure_id){
	$args = Lexical::get_lexical_binding('__pharenlang', 149, '$args', isset($__closure_id)?$__closure_id:0);;
	return apply($f, $args);
}
...
function __pharenlang__lambdafunc12($args, $__closure_id){
	...
	$args = seq(array_slice($__splatargs, 0, count($__splatargs) - 1));
	$__closure_id = last($__splatargs);
	$__scope_id = Lexical::init_closure("__pharenlang", 149);
	Lexical::bind_lexing("__pharenlang", 149, '$args', $args);
	$fs = Lexical::get_lexical_binding('__pharenlang', 148, '$fs', isset($__closure_id)?$__closure_id:0);;
...
function juxt(){
	...
	Lexical::bind_lexing("__pharenlang", 148, '$fs', $fs);
...
function __pharenlang__lambdafunc14($val, $acc, $__closure_id){
	$new_val_func = Lexical::get_lexical_binding('__pharenlang', 155, '$new_val_func', isset($__closure_id)?$__closure_id:0);;
	return ($acc . $new_val_func($val));
}

function reduce_to_str($new_val_func, $xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 155);
	Lexical::bind_lexing("__pharenlang", 155, '$new_val_func', $new_val_func);
...
function map($f, $xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 158);
	Lexical::bind_lexing("__pharenlang", 158, '$f', $f);
	if(empty__question($xs)){
		return $xs;
	}
	else{
...
function __pharenlang__lambdafunc15($pair, $acc, $__closure_id){
	$f = Lexical::get_lexical_binding('__pharenlang', 163, '$f', isset($__closure_id)?$__closure_id:0);;
	return append($f($pair[0], $pair[1]), $acc);
}

function map_pairs($f, $pairs){
	$__scope_id = Lexical::init_closure("__pharenlang", 163);
	Lexical::bind_lexing("__pharenlang", 163, '$f', $f);
