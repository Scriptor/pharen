...
function lang__lambdafunc3($arg1, $arg2, $__closure_id){
	$f = Lexical::get_lexical_binding('lang', 75, '$f', isset($__closure_id)?$__closure_id:0);;
	return (is_string($f) || is_callable($f)?$f($arg2, $arg1):$f[0]($arg2, $arg1, $f[1]));
}

function flip($f){
	$__scope_id = Lexical::init_closure("lang", 75);
	Lexical::bind_lexing("lang", 75, '$f', $f);
...
function comp($fs){
	...
	$rfs = reverse($fs);
		...
		Lexical::bind_lexing("lang", 78, '$rfs', $rfs);
...
function lang__lambdafunc7($__closure_id){
	$n = Lexical::get_lexical_binding('lang', 112, '$n', isset($__closure_id)?$__closure_id:0);;
	return cons($n, infinity(($n + 1)));
}

function infinity($n=0){
	$__scope_id = Lexical::init_closure("lang", 112);
	Lexical::bind_lexing("lang", 112, '$n', $n);
...
function lang__lambdafunc8($__closure_id){
	$x = Lexical::get_lexical_binding('lang', 114, '$x', isset($__closure_id)?$__closure_id:0);;
	return cons($x, repeat($x));
}

function repeat($x){
	$__scope_id = Lexical::init_closure("lang", 114);
	Lexical::bind_lexing("lang", 114, '$x', $x);
...
function lang__lambdafunc10($__closure_id){
	$init = Lexical::get_lexical_binding('lang', 118, '$init', isset($__closure_id)?$__closure_id:0);;
	$f = Lexical::get_lexical_binding('lang', 118, '$f', isset($__closure_id)?$__closure_id:0);;
...
function iterate($f, $init){
	...
	Lexical::bind_lexing("lang", 118, '$init', $init);
...
function lang__lambdafunc11($__closure_id){
	$xs = Lexical::get_lexical_binding('lang', 120, '$xs', isset($__closure_id)?$__closure_id:0);;
	return concat($xs, cycle($xs));
}

function cycle($xs){
	$__scope_id = Lexical::init_closure("lang", 120);
	Lexical::bind_lexing("lang", 120, '$xs', $xs);
...
function lang__lambdafunc12($__closure_id){
		...
		$xs = Lexical::get_lexical_binding('lang', 122, '$xs', isset($__closure_id)?$__closure_id:0);;
	$new_xs = map($f, $xs);
...
function cycle_with($f, $xs){
	...
	Lexical::bind_lexing("lang", 122, '$xs', $xs);
...
function reduce($f, $acc, $xs){
	$__scope_id = Lexical::init_closure("lang", 130);
	Lexical::bind_lexing("lang", 130, '$f', $f);
	while(1){
		if(empty__question($xs)){
				return $acc;
		}
...
function lang__lambdafunc13($val, $acc, $__closure_id){
	$new_val_func = Lexical::get_lexical_binding('lang', 132, '$new_val_func', isset($__closure_id)?$__closure_id:0);;
...
function reduce_to_str($new_val_func, $xs){
	...
	Lexical::bind_lexing("lang", 132, '$new_val_func', $new_val_func);
...
function until($f, $xs){
	...
	Lexical::bind_lexing("lang", 138, '$f', $f);
	while(1){
...
function lang__lambdafunc14($pair, $acc, $__closure_id){
	$f = Lexical::get_lexical_binding('lang', 139, '$f', isset($__closure_id)?$__closure_id:0);;
