...
function lang__lambdafunc3($arg1, $arg2, $__closure_id){
	$f = Lexical::get_lexical_binding('lang', 72, '$f', isset($__closure_id)?$__closure_id:0);;
	return (is_string($f) || is_callable($f)?$f($arg2, $arg1):$f[0]($arg2, $arg1, $f[1]));
}

function flip($f){
	$__scope_id = Lexical::init_closure("lang", 72);
	Lexical::bind_lexing("lang", 72, '$f', $f);
...
function lang__lambdafunc4($args, $__closure_id){
		...
		$rfs = Lexical::get_lexical_binding('lang', 75, '$rfs', isset($__closure_id)?$__closure_id:0);;
...
function comp($fs){
	...
	$rfs = reverse($fs);
		$__scope_id = Lexical::init_closure("lang", 75);
		Lexical::bind_lexing("lang", 75, '$rfs', $rfs);
...
function lang__lambdafunc7($__closure_id){
	$n = Lexical::get_lexical_binding('lang', 109, '$n', isset($__closure_id)?$__closure_id:0);;
	return cons($n, infinity(($n + 1)));
}

function infinity($n=0){
	$__scope_id = Lexical::init_closure("lang", 109);
	Lexical::bind_lexing("lang", 109, '$n', $n);
...
function lang__lambdafunc8($__closure_id){
	$x = Lexical::get_lexical_binding('lang', 111, '$x', isset($__closure_id)?$__closure_id:0);;
	return cons($x, repeat($x));
}

function repeat($x){
	$__scope_id = Lexical::init_closure("lang", 111);
	Lexical::bind_lexing("lang", 111, '$x', $x);
...
function lang__lambdafunc9($__closure_id){
	$f = Lexical::get_lexical_binding('lang', 113, '$f', isset($__closure_id)?$__closure_id:0);;
...
function lang__lambdafunc10($__closure_id){
	$init = Lexical::get_lexical_binding('lang', 115, '$init', isset($__closure_id)?$__closure_id:0);;
	$f = Lexical::get_lexical_binding('lang', 115, '$f', isset($__closure_id)?$__closure_id:0);;
...
function iterate($f, $init){
	...
	Lexical::bind_lexing("lang", 115, '$init', $init);
...
function lang__lambdafunc11($__closure_id){
	$xs = Lexical::get_lexical_binding('lang', 117, '$xs', isset($__closure_id)?$__closure_id:0);;
	return concat($xs, cycle($xs));
}

function cycle($xs){
	$__scope_id = Lexical::init_closure("lang", 117);
	Lexical::bind_lexing("lang", 117, '$xs', $xs);
...
function lang__lambdafunc12($__closure_id){
		...
		$xs = Lexical::get_lexical_binding('lang', 119, '$xs', isset($__closure_id)?$__closure_id:0);;
	$new_xs = map($f, $xs);
...
function cycle_with($f, $xs){
	...
	Lexical::bind_lexing("lang", 119, '$xs', $xs);
...
function lang__lambdafunc13($val, $acc, $__closure_id){
	$new_val_func = Lexical::get_lexical_binding('lang', 129, '$new_val_func', isset($__closure_id)?$__closure_id:0);;
...
function reduce_to_str($new_val_func, $xs){
	...
	Lexical::bind_lexing("lang", 129, '$new_val_func', $new_val_func);
