...
function __pharenlang__lambdafunc2($args, $__closure_id){
	...
	$__closure_id = last($__splatargs);
		$rfs = Lexical::get_lexical_binding('__pharenlang', 97, '$rfs', isset($__closure_id)?$__closure_id:0);;
...
function comp(){
	...
	$fs = seq(array_slice(func_get_args(), 0));
		$__scope_id = Lexical::init_closure("__pharenlang", 97);
	$rfs = reverse($fs);
		Lexical::bind_lexing("__pharenlang", 97, '$rfs', $rfs);
...
function zip_with($f, $xs, $ys){
	$__scope_id = Lexical::init_closure("__pharenlang", 133);
	Lexical::bind_lexing("__pharenlang", 133, '$f', $f);
...
function __pharenlang__lambdafunc5($__closure_id){
	$n = Lexical::get_lexical_binding('__pharenlang', 136, '$n', isset($__closure_id)?$__closure_id:0);;
	return cons($n, infinity(($n + 1)));
}

function infinity($n=0){
	$__scope_id = Lexical::init_closure("__pharenlang", 136);
	Lexical::bind_lexing("__pharenlang", 136, '$n', $n);
...
function __pharenlang__lambdafunc6($__closure_id){
	$x = Lexical::get_lexical_binding('__pharenlang', 138, '$x', isset($__closure_id)?$__closure_id:0);;
	return cons($x, repeat($x));
}

function repeat($x){
	$__scope_id = Lexical::init_closure("__pharenlang", 138);
	Lexical::bind_lexing("__pharenlang", 138, '$x', $x);
...
function __pharenlang__lambdafunc7($__closure_id){
	$f = Lexical::get_lexical_binding('__pharenlang', 140, '$f', isset($__closure_id)?$__closure_id:0);;
	return cons($f(), repeatedly($f));
}

function repeatedly($f){
	$__scope_id = Lexical::init_closure("__pharenlang", 140);
	Lexical::bind_lexing("__pharenlang", 140, '$f', $f);
...
function __pharenlang__lambdafunc8($__closure_id){
	$init = Lexical::get_lexical_binding('__pharenlang', 142, '$init', isset($__closure_id)?$__closure_id:0);;
	$f = Lexical::get_lexical_binding('__pharenlang', 142, '$f', isset($__closure_id)?$__closure_id:0);;
	return cons($init, iterate($f, $f($init)));
}

function iterate($f, $init){
	$__scope_id = Lexical::init_closure("__pharenlang", 142);
	Lexical::bind_lexing("__pharenlang", 142, '$f', $f);
	Lexical::bind_lexing("__pharenlang", 142, '$init', $init);
...
function __pharenlang__lambdafunc9($__closure_id){
	$xs = Lexical::get_lexical_binding('__pharenlang', 144, '$xs', isset($__closure_id)?$__closure_id:0);;
	return concat($xs, cycle($xs));
}

function cycle($xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 144);
	Lexical::bind_lexing("__pharenlang", 144, '$xs', $xs);
...
function __pharenlang__lambdafunc10($__closure_id){
		...
		$xs = Lexical::get_lexical_binding('__pharenlang', 146, '$xs', isset($__closure_id)?$__closure_id:0);;
	$new_xs = map($f, $xs);
...
function cycle_with($f, $xs){
	...
	Lexical::bind_lexing("__pharenlang", 146, '$xs', $xs);
...
function __pharenlang__lambdafunc11($x, $y, $__closure_id){
	$f = Lexical::get_lexical_binding('__pharenlang', 153, '$f', isset($__closure_id)?$__closure_id:0);;
	return $f($y, $x);
}

function flip($f){
	$__scope_id = Lexical::init_closure("__pharenlang", 153);
	Lexical::bind_lexing("__pharenlang", 153, '$f', $f);
...
function __pharenlang__lambdafunc13($f, $__closure_id){
	$args = Lexical::get_lexical_binding('__pharenlang', 156, '$args', isset($__closure_id)?$__closure_id:0);;
	return apply($f, $args);
}
...
function __pharenlang__lambdafunc12($args, $__closure_id){
	...
	Lexical::bind_lexing("__pharenlang", 156, '$args', $args);
	$fs = Lexical::get_lexical_binding('__pharenlang', 155, '$fs', isset($__closure_id)?$__closure_id:0);;
...
function juxt(){
	...
	$fs = seq(array_slice(func_get_args(), 0));
	$__scope_id = Lexical::init_closure("__pharenlang", 155);
	Lexical::bind_lexing("__pharenlang", 155, '$fs', $fs);
...
function __pharenlang__lambdafunc14($val, $acc, $__closure_id){
	$new_val_func = Lexical::get_lexical_binding('__pharenlang', 163, '$new_val_func', isset($__closure_id)?$__closure_id:0);;
	return ($acc . $new_val_func($val));
}

function reduce_to_str($new_val_func, $xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 163);
	Lexical::bind_lexing("__pharenlang", 163, '$new_val_func', $new_val_func);
...
function reduce_pairs($f, $acc, $xs){
	$__scope_id = Lexical::init_closure("__pharenlang", 165);
	Lexical::bind_lexing("__pharenlang", 165, '$f', $f);
	while(1){
		if(empty__question($xs)){
				return $acc;
		}
...
function until($f, $xs){
	...
	Lexical::bind_lexing("__pharenlang", 169, '$f', $f);
	while(1){
...
function map_indexed($f, $xs, $idx=0){
	...
	Lexical::bind_lexing("__pharenlang", 170, '$f', $f);
	if(empty__question($xs)){
		return $xs;
	}
	else{
...
function __pharenlang__lambdafunc15($pair, $acc, $__closure_id){
	$f = Lexical::get_lexical_binding('__pharenlang', 171, '$f', isset($__closure_id)?$__closure_id:0);;
